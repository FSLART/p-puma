#ifndef STANLEY_TEST_H_
#define STANLEY_TEST_H_
...
class Pursuit_Algorithm {
    ...
    private:
        ...
        float calculate_heading_error(geometry_msgs::msg::PoseStamped current_pose, lart_msgs::msg::PathSpline path);
        float calculate_cross_track_error(geometry_msgs::msg::PoseStamped current_pose, lart_msgs::msg::PathSpline path);
